                ...
                <div class="main-sidebar sidebar-style-2">
                    <aside id="sidebar-wrapper">
                        ...
                        <ul class="sidebar-menu">
                            <li class="menu-header">País</li>
                            <?php foreach ($competicao as $l) : ?> 
                                <li class="dropdown">
                                    <a href="<?php echo base_url('api_football/api_acao/core_competicao/' . $l->pais) ?>" class="nav-link"><span><?php echo ($l->pais) ?></span></a>                                        
                                </li> 
                            <?php endforeach; ?>
                        </ul>
                    </aside>
